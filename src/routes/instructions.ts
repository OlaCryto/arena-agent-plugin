...
export function instructionRoutes(): Router {
  const router = Router();

  router.get("/agent-instructions", (req: Request, res: Response) => {
...
`);
  ...
  router.get("/swap/agent-instructions", (req: Request, res: Response) => {
    const base = `https://${req.get("host")}`;
...
`);
  ...
  router.get("/launchpad/agent-instructions", (req: Request, res: Response) => {
    const base = `https://${req.get("host")}`;
...
`);
  ...
  router.get("/dex/agent-instructions", (req: Request, res: Response) => {
    const base = `https://${req.get("host")}`;
